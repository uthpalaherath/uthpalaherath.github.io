---
title: Using Markdown with Pandoc
bibliography: references-md.bib
subtitle: In this tutorial we explore how to generate visually appealing documents with Markdown and then convert them into Latex for further processing or export them as Pdf. All the required files are found in the same directory where this Pdf is located in. 
excerpt: This string is an excerpt of the article. 
---
...
- Typora - 
  ...
  ![What writing Markdown in Typora looks like.](images/Markdown-Tutorial/image-20200128174047615.png){#fig:typora}
...
![The caption of the image.](images/Markdown-Tutorial/image.jpg){#fig:figurelabel}
